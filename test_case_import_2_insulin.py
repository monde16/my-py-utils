...
non_insulin_dependant_inf = '/home/phoenix/Downloads/resources/pricing/magnum-pricing/mailed/davej/17-10-24/csv/NonInsulinDependent.csv'
non_insulin_dependant_outf = '/home/phoenix/Downloads/resources/pricing/magnum-pricing/mailed/davej/17-10-24/csv/NonInsulinDependent.txt'
...
full_test_cases_headers_map = {
    ...
    'Term': 'termInYears',
    'id': 'applicationID',
    'Plan Decision': 'Expected Plan Decision'
}

exclude_set = {
    'Years Since Diagnosis', 'LAUTRO', 'Scorecard Loading', 'Policy Fee', 'Base Commission Percetnage'  #, 'Plan Decision'
}
...
def csv_to_json_list(filename):
    ...
    with open(non_insulin_dependant_outf, 'w') as f:
        for row in rows:
            f.write(f'"""{str(row)}""",\n')


def main():
    csv_to_json_list(non_insulin_dependant_inf)
